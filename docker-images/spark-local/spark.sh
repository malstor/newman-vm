...
sudo cp /scripts/spark-profile.sh /etc/profile.d/spark.sh
...
# WTF ----> interior-dsgn.com .... really?!!    wget -q http://www.interior-dsgn.com/apache/spark/spark-1.5.0/spark-1.5.0-bin-hadoop2.3.tgz
    wget -q https://archive.apache.org/dist/spark/spark-1.5.0/spark-1.5.0-bin-hadoop2.3.tgz
fi
...
cp /scripts/spark-env.sh /usr/lib/spark/conf/
